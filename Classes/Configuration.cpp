...
PlainConfig s_plainConfigs[FIGHTER_MAX][FIGHTER_LEVEL_MAX] = {
    {//轻型战机，建设所需的晶石，升级所需宝石，生命，攻击，速度，防御，射程，cd
        {100,100,100,  100,100,10,130,3},
        {100,100,100,  100,100,10,140,1},
        {100,100,100,  100,100,10,150,1},

        {100,100,100,  100,100,10,160,1},
        {100,100,100,  100,100,10,170,1},
        {100,100,100,  100,100,10,180,1},

        {100,100,100,  100,100,10,190,1},
        {100,100,100,  100,100,10,200,1},
        {100,100,100,  100,100,10,210,1},

        {100,100,100,  100,100,10,225,1},
        {100,100,100,  100,100,10,225,1},
        {100,100,100,  100,100,10,225,1},
...
WeaponConfig s_weaponConfigs[WEAPON_MAX][WEAPON_LEVEL_MAX] = {
    {//星际炸弹，购买所需宝石，升级所需宝石，攻击，持续时间（0.1s为单位），携带上限，攻击范围
