...
{
    {s_battleNormalEnemyConfig_0, STAGE_ENEMY_WAVES_00},//1
    {s_battleNormalEnemyConfig_1, STAGE_ENEMY_WAVES_01},//2
    {s_battleNormalEnemyConfig_2, STAGE_ENEMY_WAVES_02}//3
};
...
{
    //等级，出现时间间隔
    {0,10},{2,10},{3,10},{4,10},{5,10},//1
    {1,10},{2,10},{3,10},{4,10},{5,10},//2
    {1,10},{2,10},{3,10},{4,10},{5,10},//3
    {1,10},{2,10},{3,10},{4,10},{5,10},//4
    {1,10},{2,10},{3,10},{4,10},{5,10},//5
    {1,10},{2,10},{3,10},{4,10},{5,10},//6
    {1,10},{2,10},{3,10},{4,10},{5,10},//7
    {1,10},{2,10},{3,10},{4,10},{5,10},//8
    {1,10},{2,10},{3,10},{4,10},{5,10},//9
    {1,10},{2,10},{3,10},{4,10},{5,10}//10
};
