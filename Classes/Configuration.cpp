...
WeaponConfig s_weaponConfigs[WEAPON_MAX][WEAPON_LEVEL_MAX] = {
    {//星际炸弹，购买所需宝石，升级所需宝石，攻击，持续时间，携带上限，攻击范围,cd
        {100,100,  100,1,20,100,1},//1
        {100,100,  100,1,20,100,1},//2
        {100,100,  100,1,20,100,1},//3
        {100,100,  100,1,20,100,1},//4
        {100,100,  100,1,20,100,1},//5

        {100,100,  100,1,20,100,1},//6
        {100,100,  100,1,20,100,1},//7
        {100,100,  100,1,20,100,1},//8
        {100,100,  100,1,20,100,1},//9
        {100,100,  100,1,20,100,1}//10
    },
    {//激光发射器，购买所需宝石，升级所需宝石，攻击，持续时间，携带上限，攻击范围,cd
        {100,100,  100,10,20,15,1},//1
        {100,100,  100,10,20,15,1},//2
        {100,100,  100,10,20,15,1},//3
        {100,100,  100,10,20,15,1},//4
        {100,100,  100,10,20,15,1},//5

        {100,100,  100,10,20,15,1},//6
        {100,100,  100,10,20,15,1},//7
        {100,100,  100,10,20,15,1},//8
        {100,100,  100,10,20,15,1},//9
        {100,100,  100,10,20,15,1}//10
    },
    {////黑洞，购买所需宝石，升级所需宝石，攻击，持续时间，携带上限，攻击范围,cd
        {100,100,  999999,5,20,150,1},//1
        {100,100,  999999,5,20,150,1},//2
        {100,100,  999999,5,20,150,1},//3
        {100,100,  999999,5,20,150,1},//4
        {100,100,  999999,5,20,150,1},//5

        {100,100,  999999,5,20,150,1},//6
        {100,100,  999999,5,20,150,1},//7
        {100,100,  999999,5,20,150,1},//8
        {100,100,  999999,5,20,150,1},//9
        {100,100,  999999,5,20,150,1}//10
    }
};
